...
function Carousel({ className, height = "70px", bgColor = "bg-white", displayArray = items, interval = true, intervalTime = 800000 }) {
    ...
    <div ref={containerRef} className="h-[300px] select-none w-full" style={{ height }}>
      <div className="relative w-full h-full">
        <div className="carousel-btns absolute h-full w-full flex items-center justify-between">
          <div className={"h-full flex items-center w-fit z-[1] " + CSS.arrowCont}>
          ...
          {stateArr.map((position, i) => {
            ...
            return (
              ...
              <div
                ...
                className={`relative row-start-1 w-full h-full snap-center flex items-center justify-center s${colors[colorPos]} ${bgColor} ${className} text-white`}
              >
                {position}
